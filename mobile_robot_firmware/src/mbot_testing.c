...
bool timer_cb(repeating_timer_t *rt)
{
    ...
    if (1)
    {
        // printf("inside motor motor control");
        ...
        printf("-----------------------");
        printf("%f\t%f\n", current_encoders.right_delta, current_encoders.left_delta);
        // -----------------------ken---------------------------
        ...
        if (1)
        {
            ...
            else
            {
                ...
                rc_filter_pid(&right_pid,
                                ...
                                1.0 / 5,
                                1.0 / MAIN_LOOP_HZ);
                l_duty += rc_filter_march(&left_pid, vel - l_wheel_speed);
                r_duty += rc_filter_march(&right_pid, vel - r_wheel_speed);
